...
internal class OptimizedLocaleTranslator(
    ...
    // кэш призван сохранять десериализированное в компонент после первой отправки сообщение для
    ...
    // по мере рассылки.
    private val propagationCache: Cache<MsgRayID, Component> = Caffeine.newBuilder()
    ...
    override fun canTranslate(key: String, locale: Locale): Boolean {
        ...
        // чего в логах было видно двойной вызов translate(), а в кэш попадали строки без подстановок.
        // Как же чёрт возьми много времени я потратил, чтобы понять всё это...
        //
    ...
    override fun translate(component: TranslatableComponent, locale: Locale): Component? {
        ...
        return propagationCache.get(MsgRayID(rayIdStr.toLong(), locale)) {
