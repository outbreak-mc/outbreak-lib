...
abstract class LocaleDataManagerBase {
    ...
    fun load(namespace: String, lang: Locale, dictionary: MutableMap<String, String>) {
        if (namespace == "*") {
    ...
    fun addPlaceholders(namespace: String, lang: Locale?, placeholders: MutableMap<String, String>) {
        if (namespace == "*") {
